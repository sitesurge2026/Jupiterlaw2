      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex items-end pb-12">
        <div className="flex flex-col items-start gap-4">
          <h1 className="flex flex-col gap-1 w-full relative">
            <span className="hero-text font-sans font-bold text-5xl md:text-7xl text-background tracking-tight translate-y-6 md:translate-y-8 relative z-20">
              Trust meets
            </span>
            <span className="hero-text font-drama italic text-7xl md:text-[9rem] lg:text-[11rem] text-accent leading-[0.85] pr-8 -ml-2 drop-shadow-2xl relative z-10">
              Assurance.
            </span>
          </h1>
          
          <p className="hero-text font-sans text-background/80 text-lg md:text-xl max-w-sm mt-8 text-balance font-light">
            Jupiter Law — precision legal strategy and definitive action for those who demand absolute resolution.
          </p>

          <button className="hero-text magnetic-btn mt-8 bg-accent text-primary px-8 py-4 rounded-full font-sans font-bold text-lg hover:bg-background transition-colors flex items-center justify-center gap-3 group">
